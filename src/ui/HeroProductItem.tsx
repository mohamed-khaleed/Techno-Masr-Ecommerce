...
function HeroProductItem() {
  return (
    <div className="w-full bg-white rounded-sm relative border border-solid border-[#C9CFD2] p-4">
      <div className="relative">
        <img src={product} alt="Product" className=" object-cover w-full h-full" />
      ...
      <div className="flex flex-col mt-2 p-3 gap-2">
        <div className="stars flex items-center  gap-1">
          ...
          <p className="text-[#77878F] text-xs">(4)</p>
        </div>
        <p className="text-darkBlack text-[14px] leading-5 ">هذا النص هو مثال لنص يمكن أن يستبدل في نفس المساحة.</p>
        <span className="text-darkBlue  text-[14px] leading-5 font-semibold">424.50 ر.س</span>
      </div>
      <div className="bg-darkGrey absolute top-4 right-[5%] py-[5px] px-[10px] rounded-sm">
        <p className="text-xs font-semibold uppercase text-white">sold out</p>
      </div>
    </div>
  );
}
