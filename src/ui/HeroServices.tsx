...
function HeroServices() {
  return (
    <section className="flex items-center justify-center gap-5 bg-lightBlue p-7">
      <HeroServiceItem heading="Secure payment" paragraph="Your money is safe.">
        <svg
          width="40"
          height="40"
          viewBox="0 0 40 40"
      ...
      <HeroServiceItem
        heading="Return within 24 hours"
      ...
      <HeroServiceItem heading="Fast delivery" paragraph="Delivery within 24 hours">
        <svg
          width="40"
          height="40"
          viewBox="0 0 40 40"
